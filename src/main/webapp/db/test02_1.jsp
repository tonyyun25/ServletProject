...
<body>
	...
	String query = "SELECT `id`, `name`, `url` FROM `urlAddress` ORDER BY `id` DESC";// id 포함해야 아래 됨
		...
		<table class="table text-center">
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="/db/test02/delete?id=<%=result.getInt("id") %>" class="btn btn-danger btn-sm">삭제</a></td>
				</tr>
				<%
				}
				%>
